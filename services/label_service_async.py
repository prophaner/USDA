"""
Async label generation service.
...
async def generate_label(label_input: LabelInput) -> LabelOutput:
    """
    ...
    """
    # Validate the input
    is_valid, missing_elements = await validate_label_input(label_input)
    if not is_valid:
...
async def check_label_requirements(label_input: LabelInput) -> Tuple[bool, Optional[LabelValidationError]]:
    """
